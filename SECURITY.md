...
[GitHub Security Advisories](https://github.com/baileyrd/rusty_bullet/security/advisories/new),
or reach baileyrd (repo owner) directly if advisories aren't set up on this repo yet.
