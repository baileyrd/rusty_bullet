...
|---|---|---:|---|---|---|---|---|---|---|
| `RB-VERIFY-001` | Replay Ingestion | 0.1.0 | Draft | Not Started | Not Verified | — | baileyrd | [spec](verification/RB-VERIFY-001-replay-ingestion.md) | — |
...
| `RB-PHYSICS-001` | Physics Core Port | 0.1.0 | Draft (placeholder) | Not Started | Not Verified | RB-VERIFY-003 | baileyrd | [spec](physics/RB-PHYSICS-001-physics-core-port.md) | — |
