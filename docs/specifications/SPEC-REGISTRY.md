...
| `RB-PHYSICS-001` | Physics Core Port | 0.5.0 | In Progress | In Progress (sphere + box bodies, ball-vs-car and car-vs-car collision detection; FR-005 open, multi-car wiring open) | Verified (unit tests; not yet scored against real data) | RB-VERIFY-003 | baileyrd | [spec](physics/RB-PHYSICS-001-physics-core-port.md) | `crates/rb_physics_bullet` tests (62) |
