...
|---|---|---:|---|---|---|---|---|---|---|
| `RB-VERIFY-001` | Replay Ingestion | 0.3.0 | In Progress | In Progress (FR-001/002/003) | Verified (real fixture + 40-replay owner corpus) | — | baileyrd | [spec](verification/RB-VERIFY-001-replay-ingestion.md) | `crates/rb_replay_ingest` tests (10) + `corpus_check` (40/40) |
