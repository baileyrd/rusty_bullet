...
| `RB-VERIFY-003` | Divergence Scoring | 0.3.0 | Draft | In Progress (ball + car scoring, CLI wiring; FR-003 open) | Verified (algorithm + mechanical end-to-end run) | RB-VERIFY-001, RB-VERIFY-002 | baileyrd | [spec](verification/RB-VERIFY-003-divergence-scoring.md) | `crates/rb_domain/src/divergence.rs` tests (8) + `angle_to` tests (3) + `rb_verify_cli` tests (3) |
