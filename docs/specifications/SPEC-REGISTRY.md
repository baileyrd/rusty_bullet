...
| `RB-VERIFY-003` | Divergence Scoring | 0.2.0 | Draft | In Progress (core algorithm + CLI wiring) | Verified (algorithm + mechanical end-to-end run) | RB-VERIFY-001, RB-VERIFY-002 | baileyrd | [spec](verification/RB-VERIFY-003-divergence-scoring.md) | `crates/rb_domain/src/divergence.rs` tests (4) + `rb_verify_cli` tests (3) |
