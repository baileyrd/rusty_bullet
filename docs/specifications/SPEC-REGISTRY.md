...
| `RB-PHYSICS-001` | Physics Core Port | 0.21.0 | In Progress | In Progress (sphere + box bodies, ball-vs-car, car-vs-car, body-vs-arena-wall, and ball-vs-curved-fillet collision wired into a multi-car `PhysicsWorld`, ground-driving car input, boost, handbrake, a variable-height ground jump, a double jump (plain or a flip-cancelable dodge), a wall jump (itself dodgeable), air control, a gentle landing auto-orientation assist, a modeled octagonal arena footprint, and curved wall-to-floor/wall-to-ceiling transitions for the ball at all 9 walls (cardinal and diagonal corner); FR-005 open, car-vs-curve/corner-vertical-edge fillets/goal cutouts open) | Verified (unit tests; not yet scored against real data) | RB-VERIFY-003 | baileyrd | [spec](physics/RB-PHYSICS-001-physics-core-port.md) | `crates/rb_physics_bullet` tests (172) |
