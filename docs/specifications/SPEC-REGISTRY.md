...
| `RB-PHYSICS-001` | Physics Core Port | 0.4.0 | In Progress | In Progress (sphere + box bodies, ball-vs-car collision; FR-005 open) | Verified (unit tests; not yet scored against real data) | RB-VERIFY-003 | baileyrd | [spec](physics/RB-PHYSICS-001-physics-core-port.md) | `crates/rb_physics_bullet` tests (58) |
