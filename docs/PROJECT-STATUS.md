...
- `RB-PHYSICS-001-FR-040` (fillet-radius calibration research, investigated)
  ...
  pass unchanged. 268 total in `rb_physics_bullet` (unchanged from
  FR-039).
...
- `cargo test --workspace`: pass (318 tests: 23 in `rb_domain`, 268 in
