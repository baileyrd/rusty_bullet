...
- Last verified main commit: `51e633a` (merge of [#73](https://github.com/baileyrd/rusty_bullet/pull/73))
...
- `cargo test --workspace`: pass (296 tests: 23 in `rb_domain`, 246 in
