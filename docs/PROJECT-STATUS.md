...
- Last verified main commit: `f92ceed` (merge of [#87](https://github.com/baileyrd/rusty_bullet/pull/87))
...
- `cargo test --workspace`: pass (321 tests: 23 in `rb_domain`, 271 in
