...
- `RB-PHYSICS-001-FR-038` (car-vs-net contact, implemented) — closes this
  ...
  pass unchanged. 270 total in `rb_physics_bullet` (+3 over FR-037's 267).
...
- `cargo test --workspace`: pass (320 tests: 23 in `rb_domain`, 270 in
